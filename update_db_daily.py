...
# Get the day's potential trades (get_stocks_periods())
tups = get_stocks_periods()

# Filter by weekday
filtered_tups = [x for x in tups if x[1] == day_int]
...
update_list = sorted(later_CoList + list(proxies))
